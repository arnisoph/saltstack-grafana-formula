...
SaltStack formula to manage Grafana, a web-based visualizer of time series data
...
But it’s better to `file an issue <https://github.com/bechtoldt/saltstack-grafana-formula/issues/new>`_ with your idea first.
